...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content="https://www.bookforfix.com/assets/image/logo.png">
        ...
        <div class="page-wrapper">
                    ...
                    <div class="topbar-one__inner">
                        <ul class="list-unstyled topbar-one__info">
                            <li class="topbar-one__info__item">
                                ...
                                <a href="#">Iridium Building, Al Barsha 1, Dubai, UAE</a>
                            </li>
                            <li class="topbar-one__info__item">
                ...
                <div class="main-slider-one__carousel wallpi-owl__carousel owl-carousel" data-owl-options='{
                    ...
                    <div class="item">
                        <div class="main-slider-one__item">
                            <div class="main-slider-one__bg" style="background-image: url(assets/images/sliders/maintenance.jpg);"></div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <div class="main-slider-one__shope">
                                <img src="assets/images/shapes/rennovation.png" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="main-slider-one__item">
                            <div class="main-slider-one__bg" style="background-image: url(assets/images/sliders/plumbing-new.jpg);"></div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="main-slider-one__content">
                            ...
                            <div class="main-slider-one__shope">
                                <img src="assets/images/shapes/plumbing.png" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="main-slider-one__item">
                            <div class="main-slider-one__bg" style="background-image: url(assets/images/sliders/painting.jpg);"></div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="main-slider-one__content">
                            ...
                            <div class="main-slider-one__shope">
                                <img src="assets/images/shapes/painting-brush.png" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="main-slider-one__item">
                            <div class="main-slider-one__bg" style="background-image: url(assets/images/sliders/handyman-new.jpg);"></div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="main-slider-one__content">
                            ...
                            <div class="main-slider-one__shope">
                                <img src="assets/images/shapes/handyman.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="about-one__content__call" style="margin-top:-20px;">
                                    <div class="about-one__content__inner d-flex align-items-center">
                                        <img class="about-one__content__expertimg"
                                            src="assets/images/about/about-bg-img.jpg" alt="Book for Fix">
                        ...
                        <div class="col-lg-6">
                            <div class="about-one__image wow fadeInLeft" data-wow-delay="300ms">
                                <div class="about-one__image__wrap">
                                    ...
                                    <img class="about-one__image__wrap__main" src="assets/images/about/about-bg-img.jpg" alt="Book for Fix">
                                    <div class="about-one__image__wrap__inner_wrap">
                                        <div class="about-one__image__wrap__inner_mx">
                                            <img class="about-one__image__wrap__inner_img" src="assets/images/about/about-front-min.jpg" alt="Book for Fix">
                                            ...
                                            <div class="about-one__image__wrap__circle">
                                                <img src="assets/images/about/logo-about.png" alt="Book for Fix">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="service-one service-one--three">
                <div class="service-one__bg"
                    style="background-image: url('assets/images/backgrounds/feature-bg2-1.jpg'), url('assets/images/resources/services-feedback-bg2-1.jpg')">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row gutter-y-20">
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-one__item">
                                <div class="service-one__item__image">
                                    <img src="assets/images/services/service-thumbnail-ac.png" alt="AC Repair & Maintenance">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-one__item">
                                <div class="service-one__item__image">
                                    <img src="assets/images/services/service-thumbnail-coil-cleaning.png" alt="Coil Cleaning">
                                    <div class="service-one__item__titlewrap d-flex align-items-center justify-content-between">
                                        <h4 class="service-one__item__title">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-one__item">
                                <div class="service-one__item__image">
                                    <img src="assets/images/services/service-thumbnail-duct-cleaning.png" alt="Duct Cleaning">
                                    <div class="service-one__item__titlewrap d-flex align-items-center justify-content-between">
                                        <h4 class="service-one__item__title">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-one__item">
                                <div class="service-one__item__image">
                                    <img src="assets/images/services/service-thumbnail-electrical.png" alt="Electrical Work">
                                    <div class="service-one__item__titlewrap d-flex align-items-center justify-content-between">
                                        <h4 class="service-one__item__title">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-one__item">
                                <div class="service-one__item__image">
                                    <img src="assets/images/services/service-thumbnail-plumbing.png" alt="Plumbing Services">
                                    <div class="service-one__item__titlewrap d-flex align-items-center justify-content-between">
                                        <h4 class="service-one__item__title">
                                            <a href="#">Plumbing</a>
                                        </h4>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-one__item">
                                <div class="service-one__item__image">
                                    <img src="assets/images/services/service-thumbnail-painting.png" alt="Painting">
                                    <div class="service-one__item__titlewrap d-flex align-items-center justify-content-between">
                                        <h4 class="service-one__item__title">
                                            <a href="#">Painting</a>
                                        </h4>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-one__item">
                                <div class="service-one__item__image">
                                    <img src="assets/images/services/service-thumbnail-carpentary.png" alt="Carpentry">
                                    <div class="service-one__item__titlewrap d-flex align-items-center justify-content-between">
                                        <h4 class="service-one__item__title">
                                            <a href="#">Carpentry</a>
                                        </h4>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-one__item">
                                <div class="service-one__item__image">
                                    <img src="assets/images/services/service-thumbnail-water-tank.png" alt="Water Tank Cleaning">
                                    <div class="service-one__item__titlewrap d-flex align-items-center justify-content-between">
                                        <h4 class="service-one__item__title">
                    ...
                    <div class="row services-feedback-one__row">
                        ...
                        <div class="col-lg-5 wow fadeInRight" data-wow-delay="100ms">
                            <div class="services-feedback-one__image">
                                <img src="assets/images/services/comapny-services-rate.png" alt="Book for Fix">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="project-one project-one--three">
                <div class="project-one__bg"
                    style="background-image: url('assets/images/projects/bg.png');"></div>
                <div class="container-fluid">
                    <div class="sec-title">
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="project-one__item">
                                <div class="project-one__item__image">
                                    <img src="assets/images/projects/project-thumbnail.png" alt="project">
                                </div>
            ...
            <section class="consultation-one consultation-one--three">
                <div class="consultation-one__bg"
                    style="background-image: url('assets/images/shapes/consultation-shape1-1.png');"></div>
                    ...
                    <div class="row consultation-one__row">
                        <div class="consultation-one__colimg">
                            <div class="consultation-one__colimg__image">
                                <div class="consultation-one__colimg__image__mainimg">
                                    <img src="assets/images/sliders/handyman-new.jpg" alt="Book for Fix">
                                </div>

                                <div class="consultation-one__colimg__image__circlemediam">
                                    <img src="assets/images/sliders/home-renovation.jpg" alt="Book for Fix">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="consultation-one__contentwrap">
                            <div class="consultation-one__contentwrap__bg"
                                style="background-image: url('assets/images/backgrounds/consultation-bg1-1.png');">
                            </div>
                            ...
                            <div class="consultation-one__contentwrap__call">
                                <div class="consultation-one__contentwrap__inner">
                                    <i class="icon-phone-call"></i>
                                    <p class="consultation-one__contentwrap__telnumber">Call Anytime <a
                                            href="tel:+971585861272">+971 58 586 1272</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="blog-one blog-one--three">
                <div class="blog-one__bg" style="background-image: url('assets/images/backgrounds/blog-bg1-1.jpg');">
                </div>
                <div class="container">
                    <div class="sec-title">
                        ...
                        <div class="item">
                            <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                                <div class="blog-card__image">
                                    <img src="assets/images/blog/blog-post1-1.jpg"
